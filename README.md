...
* BowTie2 is needed for ShapeMapper. Available here: https://sourceforge.net/projects/bowtie-bio/files/bowtie2/2.3.2. As of 2017, the 'legacy' version may be the one you want to download.
* numpy
